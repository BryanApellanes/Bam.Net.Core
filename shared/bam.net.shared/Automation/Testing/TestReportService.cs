...
namespace Bam.Net.Automation.Testing
{
    ...
    {
        protected TestReportService() : this(new SQLiteDatabaseProvider(DefaultDatabaseDirectoryProvider.Current.GetSysDatabaseDirectory().FullName, Log.Default), Log.Default)
        {
        }
