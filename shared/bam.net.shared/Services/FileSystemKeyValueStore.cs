...
namespace Bam.Net.Services
{
    public class FileSystemKeyValueStore : IKeyValueStore
    {
        ...
        public FileSystemKeyValueStore(ILogger logger = null)
        {
            ...
            LocalStorage = new DirectoryInfo(Path.Combine(DataProvider.Current.GetAppFilesDirectory(DefaultConfigurationApplicationNameProvider.Instance).FullName, DirectoryName));
