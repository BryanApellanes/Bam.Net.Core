...
namespace Bam.Net.Services
{
    ...
    public class LocalServiceRegistryContainer
    {
        ...
        public static ServiceRegistry Create()
        {
            ...
            DaoRepository repo = new DaoRepository(DefaultDatabaseDirectoryProvider.Current.GetSysDatabase(nameof(CatalogRepository)), Log.Default);
            ...
            ServiceRegistry reg = (ServiceRegistry)(new ServiceRegistry())
                ...
                .For<SystemPaths>().Use(DefaultDatabaseDirectoryProvider.GetPaths())
