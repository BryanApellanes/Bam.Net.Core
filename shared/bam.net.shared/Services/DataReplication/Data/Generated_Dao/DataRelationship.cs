...
namespace Bam.Net.Services.DataReplication.Data.Dao
{
	...
	[Serializable]
	[Bam.Net.Data.Table("DataRelationship", "DataReplication")]
	public partial class DataRelationship: Bam.Net.Data.Dao
	{
		public DataRelationship():base()
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}

		public DataRelationship(DataRow data)
			: base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		...
		public DataRelationship(Database db)
			: base(db)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		...
		public DataRelationship(Database db, DataRow data)
			: base(db, data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		...
		[Bam.Net.Exclude]
		public static implicit operator DataRelationship(DataRow data)
		{
			return new DataRelationship(data);
		}
	...
	public string LeftCuid
	{
		get
		{
			return GetStringValue("LeftCuid");
		}
		set
		{
			SetValue("LeftCuid", value);
		}
	}
	...
	public string RightCuid
	{
		get
		{
			return GetStringValue("RightCuid");
		}
		set
		{
			SetValue("RightCuid", value);
		}
	}
	...
	public string RelationshipDescription
	{
		get
		{
			return GetStringValue("RelationshipDescription");
		}
		set
		{
			SetValue("RelationshipDescription", value);
		}
	}
	...
	public DateTime? Created
	{
		...
		public static DataRelationship GetById(uint? id, Database database = null)
		{
			...
			Args.ThrowIf(!id.HasValue, "specified DataRelationship.Id was null");
		...
		public static DataRelationship GetByUuid(string uuid, Database database = null)
		{
			return OneWhere(c => Bam.Net.Data.Query.Where("Uuid") == uuid, database);
		}

		public static DataRelationship GetByCuid(string cuid, Database database = null)
		{
			return OneWhere(c => Bam.Net.Data.Query.Where("Cuid") == cuid, database);
		}

		[Bam.Net.Exclude]
		public static DataRelationshipCollection Query(QueryFilter filter, Database database = null)
		{
		...
		/// <param name="db"></param>
		[Bam.Net.Exclude]
		public static DataRelationshipCollection Where(Func<DataRelationshipColumns, QueryFilter<DataRelationshipColumns>> where, OrderBy<DataRelationshipColumns> orderBy = null, Database database = null)
		{
		...
		/// <param name="database"></param>
		public static DataRelationshipCollection Where(QiQuery where, Database database = null)
		{
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static DataRelationship GetOneWhere(QueryFilter where, Database database = null)
		{
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static DataRelationship OneWhere(QueryFilter where, Database database = null)
		{
			WhereDelegate<DataRelationshipColumns> whereDelegate = (c) => where;
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static DataRelationship GetOneWhere(WhereDelegate<DataRelationshipColumns> where, Database database = null)
		{
			var result = OneWhere(where, database);
			if(result == null)
			{
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static DataRelationship OneWhere(WhereDelegate<DataRelationshipColumns> where, Database database = null)
		{
		...
		/// <param name="where"></param>
		/// <param name="database"></param>
		public static DataRelationship OneWhere(QiQuery where, Database database = null)
		{
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static DataRelationship FirstOneWhere(WhereDelegate<DataRelationshipColumns> where, Database database = null)
		{
			var results = Top(1, where, database);
			if(results.Count > 0)
			{
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static DataRelationship FirstOneWhere(WhereDelegate<DataRelationshipColumns> where, OrderBy<DataRelationshipColumns> orderBy, Database database = null)
		{
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static DataRelationship FirstOneWhere(QueryFilter where, OrderBy<DataRelationshipColumns> orderBy = null, Database database = null)
		{
			WhereDelegate<DataRelationshipColumns> whereDelegate = (c) => where;
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static DataRelationshipCollection Top(int count, WhereDelegate<DataRelationshipColumns> where, Database database = null)
		{
		...
		[Bam.Net.Exclude]
		public static DataRelationshipCollection Top(int count, QueryFilter where, Database database)
		{
			return Top(count, where, null, database);
		}
		/// <summary>
		...
		/// </param>
		[Bam.Net.Exclude]
		public static DataRelationshipCollection Top(int count, QueryFilter where, OrderBy<DataRelationshipColumns> orderBy = null, Database database = null)
		{
			Database db = database ?? Db.For<DataRelationship>();
			QuerySet query = GetQuerySet(db);
			query.Top<DataRelationship>(count);
		...
		/// Which database to query or null to use the default
		/// </param>
		public static DataRelationshipCollection Top(int count, QiQuery where, Database database = null)
		{
			Database db = database ?? Db.For<DataRelationship>();
			QuerySet query = GetQuerySet(db);
			query.Top<DataRelationship>(count);
		...
		/// </param>
		[Bam.Net.Exclude]
		public static long Count(WhereDelegate<DataRelationshipColumns> where, Database database = null)
		{
			DataRelationshipColumns c = new DataRelationshipColumns();
			IQueryFilter filter = where(c) ;
