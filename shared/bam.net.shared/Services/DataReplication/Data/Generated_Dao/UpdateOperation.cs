...
namespace Bam.Net.Services.DataReplication.Data.Dao
{
	...
	[Serializable]
	[Bam.Net.Data.Table("UpdateOperation", "DataReplication")]
	public partial class UpdateOperation: Bam.Net.Data.Dao
	{
		...
		private void SetChildren()
		{
			...
			if(_database != null)
			{
				this.ChildCollections.Add("DataProperty_UpdateOperationId", new DataPropertyCollection(Database.GetQuery<DataPropertyColumns, DataProperty>((c) => c.UpdateOperationId == GetULongValue("Id")), this, "UpdateOperationId"));
			}
	...
	public DataPropertyCollection DataPropertiesByUpdateOperationId
	{
		...
		public static UpdateOperation GetById(uint? id, Database database = null)
		{
			Args.ThrowIfNull(id, "id");
			Args.ThrowIf(!id.HasValue, "specified UpdateOperation.Id was null");
		...
		public static UpdateOperation GetById(ulong? id, Database database = null)
		{
			Args.ThrowIfNull(id, "id");
			Args.ThrowIf(!id.HasValue, "specified UpdateOperation.Id was null");
			return GetById(id.Value, database);
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<UpdateOperationColumns> where, Database database = null)
		{
			SetOneWhere(where, out UpdateOperation ignore, database);
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<UpdateOperationColumns> where, out UpdateOperation result, Database database = null)
		{
		...
		[Bam.Net.Exclude]
		public static UpdateOperationCollection Top(int count, QueryFilter where, string orderBy = null, SortOrder sortOrder = SortOrder.Ascending, Database database = null)
		{
			Database db = database ?? Db.For<UpdateOperation>();
			QuerySet query = GetQuerySet(db);
			query.Top<UpdateOperation>(count);
