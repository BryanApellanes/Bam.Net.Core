...
namespace Bam.Net.Services.DataReplication.Data.Dao
{
	...
	public partial class SaveOperation: Bam.Net.Data.Dao
	{
		...
		private void SetChildren()
		{
			...
			if(_database != null)
			{
				this.ChildCollections.Add("DataProperty_SaveOperationId", new DataPropertyCollection(Database.GetQuery<DataPropertyColumns, DataProperty>((c) => c.SaveOperationId == GetULongValue("Id")), this, "SaveOperationId"));
			}
	...
	public DataPropertyCollection DataPropertiesBySaveOperationId
	{
		...
		public static SaveOperation GetById(uint? id, Database database = null)
		{
			Args.ThrowIfNull(id, "id");
			Args.ThrowIf(!id.HasValue, "specified SaveOperation.Id was null");
		...
		public static SaveOperation GetById(ulong? id, Database database = null)
		{
			Args.ThrowIfNull(id, "id");
			Args.ThrowIf(!id.HasValue, "specified SaveOperation.Id was null");
			return GetById(id.Value, database);
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<SaveOperationColumns> where, Database database = null)
		{
			SetOneWhere(where, out SaveOperation ignore, database);
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<SaveOperationColumns> where, out SaveOperation result, Database database = null)
		{
