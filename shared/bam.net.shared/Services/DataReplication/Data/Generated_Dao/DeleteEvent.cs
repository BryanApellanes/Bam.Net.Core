...
namespace Bam.Net.Services.DataReplication.Data.Dao
{
	...
	public partial class DeleteEvent: Bam.Net.Data.Dao
	{
		...
		private void SetChildren()
		{
			...
			if(_database != null)
			{
				this.ChildCollections.Add("DataProperty_DeleteEventId", new DataPropertyCollection(Database.GetQuery<DataPropertyColumns, DataProperty>((c) => c.DeleteEventId == GetULongValue("Id")), this, "DeleteEventId"));
			}
	...
	public DataPropertyCollection DataPropertiesByDeleteEventId
	{
		...
		public static DeleteEvent GetById(uint? id, Database database = null)
		{
			Args.ThrowIfNull(id, "id");
			Args.ThrowIf(!id.HasValue, "specified DeleteEvent.Id was null");
		...
		public static DeleteEvent GetById(ulong? id, Database database = null)
		{
			Args.ThrowIfNull(id, "id");
			Args.ThrowIf(!id.HasValue, "specified DeleteEvent.Id was null");
			return GetById(id.Value, database);
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<DeleteEventColumns> where, Database database = null)
		{
			SetOneWhere(where, out DeleteEvent ignore, database);
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<DeleteEventColumns> where, out DeleteEvent result, Database database = null)
		{
