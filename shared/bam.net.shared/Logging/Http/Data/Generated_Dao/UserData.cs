...
namespace Bam.Net.Logging.Http.Data.Dao
{
	...
	public DateTime? Created
	{
		...
		public static UserData GetById(uint? id, Database database = null)
		{
			...
			Args.ThrowIf(!id.HasValue, "specified UserData.Id was null");
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<UserDataColumns> where, Database database = null)
		{
			SetOneWhere(where, out UserData ignore, database);
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<UserDataColumns> where, out UserData result, Database database = null)
		{
