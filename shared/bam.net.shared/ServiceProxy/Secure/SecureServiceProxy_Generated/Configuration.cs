...
namespace Bam.Net.ServiceProxy.Secure
{
	...
	public partial class Configuration: Bam.Net.Data.Dao
	{
		...
		private void SetChildren()
		{
			...
			if(_database != null)
			{
				this.ChildCollections.Add("ConfigSetting_ConfigurationId", new ConfigSettingCollection(Database.GetQuery<ConfigSettingColumns, ConfigSetting>((c) => c.ConfigurationId == GetULongValue("Id", false)), this, "ConfigurationId"));
			}
	...
	public ConfigSettingCollection ConfigSettingsByConfigurationId
	{
		...
		public static Configuration GetById(uint? id, Database database = null)
		{
			...
			Args.ThrowIf(!id.HasValue, "specified Configuration.Id was null");
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<ConfigurationColumns> where, Database database = null)
		{
			SetOneWhere(where, out Configuration ignore, database);
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<ConfigurationColumns> where, out Configuration result, Database database = null)
		{
