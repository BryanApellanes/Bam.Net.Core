...
namespace Bam.Net.CoreServices.WebHooks.Data.Dao
{
	...
	public WebHookSubscriber WebHookSubscriberOfWebHookSubscriberId
	{
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<WebHookDescriptorWebHookSubscriberColumns> where, Database database = null)
		{
			SetOneWhere(where, out WebHookDescriptorWebHookSubscriber ignore, database);
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<WebHookDescriptorWebHookSubscriberColumns> where, out WebHookDescriptorWebHookSubscriber result, Database database = null)
		{
