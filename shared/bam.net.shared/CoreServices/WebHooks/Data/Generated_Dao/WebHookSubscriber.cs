...
namespace Bam.Net.CoreServices.WebHooks.Data.Dao
{
	...
	public WebHookDescriptorWebHookSubscriberCollection WebHookDescriptorWebHookSubscribersByWebHookSubscriberId
	{
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<WebHookSubscriberColumns> where, Database database = null)
		{
			SetOneWhere(where, out WebHookSubscriber ignore, database);
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<WebHookSubscriberColumns> where, out WebHookSubscriber result, Database database = null)
		{
