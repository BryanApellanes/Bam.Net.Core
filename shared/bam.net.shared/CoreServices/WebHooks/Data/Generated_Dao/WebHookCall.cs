...
namespace Bam.Net.CoreServices.WebHooks.Data.Dao
{
	...
	public WebHookDescriptor WebHookDescriptorOfWebHookDescriptorId
	{
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<WebHookCallColumns> where, Database database = null)
		{
			SetOneWhere(where, out WebHookCall ignore, database);
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<WebHookCallColumns> where, out WebHookCall result, Database database = null)
		{
