...
namespace Bam.Net.CoreServices.Auth.Data.Dao
{
	...
	public class OAuthProviderSettingsDataQueryContext
	{
			...
			{
				return Bam.Net.CoreServices.Auth.Data.Dao.OAuthProviderSettingsData.Where(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Auth.Data.Dao.OAuthProviderSettingsData.Where(where, orderBy, db);
			}

			public OAuthProviderSettingsData OneWhere(WhereDelegate<OAuthProviderSettingsDataColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Auth.Data.Dao.OAuthProviderSettingsData.OneWhere(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Auth.Data.Dao.OAuthProviderSettingsData.GetOneWhere(where, db);
			}
		
			public OAuthProviderSettingsData FirstOneWhere(WhereDelegate<OAuthProviderSettingsDataColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Auth.Data.Dao.OAuthProviderSettingsData.FirstOneWhere(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Auth.Data.Dao.OAuthProviderSettingsData.Top(count, where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Auth.Data.Dao.OAuthProviderSettingsData.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<OAuthProviderSettingsDataColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Auth.Data.Dao.OAuthProviderSettingsData.Count(where, db);
			}
	}
