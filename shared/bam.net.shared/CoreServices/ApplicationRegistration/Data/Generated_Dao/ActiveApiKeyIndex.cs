...
namespace Bam.Net.CoreServices.ApplicationRegistration.Data.Dao
{
	...
	public DateTime? Created
	{
		...
		public static ActiveApiKeyIndex GetById(uint? id, Database database = null)
		{
			...
			Args.ThrowIf(!id.HasValue, "specified ActiveApiKeyIndex.Id was null");
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<ActiveApiKeyIndexColumns> where, Database database = null)
		{
			SetOneWhere(where, out ActiveApiKeyIndex ignore, database);
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<ActiveApiKeyIndexColumns> where, out ActiveApiKeyIndex result, Database database = null)
		{
