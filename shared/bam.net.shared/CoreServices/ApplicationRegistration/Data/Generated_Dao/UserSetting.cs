...
namespace Bam.Net.CoreServices.ApplicationRegistration.Data.Dao
{
	...
	[Serializable]
	[Bam.Net.Data.Table("UserSetting", "ApplicationRegistration")]
	public partial class UserSetting: Bam.Net.Data.Dao
	{
		...
		public UserSetting(DataRow data)
			: base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		...
		public UserSetting(Database db)
			: base(db)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		...
		public UserSetting(Database db, DataRow data)
			: base(db, data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		...
		[Bam.Net.Exclude]
		public static implicit operator UserSetting(DataRow data)
		{
	...
	public DateTime? Created
	{
		...
		public static UserSetting GetById(uint? id, Database database = null)
		{
			...
			Args.ThrowIf(!id.HasValue, "specified UserSetting.Id was null");
		...
		public static UserSetting GetById(int? id, Database database = null)
		{
			Args.ThrowIfNull(id, "id");
			Args.ThrowIf(!id.HasValue, "specified UserSetting.Id was null");
			return GetById(id.Value, database);
		...
		public static UserSetting GetById(long? id, Database database = null)
		{
			Args.ThrowIfNull(id, "id");
			Args.ThrowIf(!id.HasValue, "specified UserSetting.Id was null");
			return GetById(id.Value, database);
		...
		public static UserSetting GetById(ulong? id, Database database = null)
		{
			Args.ThrowIfNull(id, "id");
			Args.ThrowIf(!id.HasValue, "specified UserSetting.Id was null");
			return GetById(id.Value, database);
		...
		public static UserSetting GetByUuid(string uuid, Database database = null)
		{
			return OneWhere(c => Bam.Net.Data.Query.Where("Uuid") == uuid, database);
		}

		public static UserSetting GetByCuid(string cuid, Database database = null)
		{
			return OneWhere(c => Bam.Net.Data.Query.Where("Cuid") == cuid, database);
		}

		[Bam.Net.Exclude]
		public static UserSettingCollection Query(QueryFilter filter, Database database = null)
		{
		...
		/// <param name="db"></param>
		[Bam.Net.Exclude]
		public static UserSettingCollection Where(Func<UserSettingColumns, QueryFilter<UserSettingColumns>> where, OrderBy<UserSettingColumns> orderBy = null, Database database = null)
		{
		...
		/// <param name="database"></param>
		public static UserSettingCollection Where(QiQuery where, Database database = null)
		{
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static UserSetting GetOneWhere(QueryFilter where, Database database = null)
		{
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static UserSetting OneWhere(QueryFilter where, Database database = null)
		{
			WhereDelegate<UserSettingColumns> whereDelegate = (c) => where;
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static UserSetting GetOneWhere(WhereDelegate<UserSettingColumns> where, Database database = null)
		{
			var result = OneWhere(where, database);
			if(result == null)
			{
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static UserSetting OneWhere(WhereDelegate<UserSettingColumns> where, Database database = null)
		{
		...
		/// <param name="where"></param>
		/// <param name="database"></param>
		public static UserSetting OneWhere(QiQuery where, Database database = null)
		{
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static UserSetting FirstOneWhere(WhereDelegate<UserSettingColumns> where, Database database = null)
		{
			var results = Top(1, where, database);
			if(results.Count > 0)
			{
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static UserSetting FirstOneWhere(WhereDelegate<UserSettingColumns> where, OrderBy<UserSettingColumns> orderBy, Database database = null)
		{
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static UserSetting FirstOneWhere(QueryFilter where, OrderBy<UserSettingColumns> orderBy = null, Database database = null)
		{
			WhereDelegate<UserSettingColumns> whereDelegate = (c) => where;
		...
		/// <param name="database"></param>
		[Bam.Net.Exclude]
		public static UserSettingCollection Top(int count, WhereDelegate<UserSettingColumns> where, Database database = null)
		{
		...
		public static UserSettingCollection Top(int count, WhereDelegate<UserSettingColumns> where, OrderBy<UserSettingColumns> orderBy, Database database = null)
		{
			...
			query.Execute(db);
			var results = query.Results.As<UserSettingCollection>(0);
			results.Database = db;
			return results;
		}

		[Bam.Net.Exclude]
		public static UserSettingCollection Top(int count, QueryFilter where, Database database)
		{
			return Top(count, where, null, database);
		}
		/// <summary>
		...
		/// </param>
		[Bam.Net.Exclude]
		public static UserSettingCollection Top(int count, QueryFilter where, OrderBy<UserSettingColumns> orderBy = null, Database database = null)
		{
			Database db = database ?? Db.For<UserSetting>();
			QuerySet query = GetQuerySet(db);
			query.Top<UserSetting>(count);
		...
		[Bam.Net.Exclude]
		public static UserSettingCollection Top(int count, QueryFilter where, string orderBy = null, SortOrder sortOrder = SortOrder.Ascending, Database database = null)
		{
			Database db = database ?? Db.For<UserSetting>();
			QuerySet query = GetQuerySet(db);
			query.Top<UserSetting>(count);
		...
		/// Which database to query or null to use the default
		/// </param>
		public static UserSettingCollection Top(int count, QiQuery where, Database database = null)
		{
			Database db = database ?? Db.For<UserSetting>();
			QuerySet query = GetQuerySet(db);
			query.Top<UserSetting>(count);
