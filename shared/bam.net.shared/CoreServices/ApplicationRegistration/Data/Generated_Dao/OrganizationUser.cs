...
namespace Bam.Net.CoreServices.ApplicationRegistration.Data.Dao
{
	...
	public User UserOfUserId
	{
		...
		public static OrganizationUser GetById(uint? id, Database database = null)
		{
			...
			Args.ThrowIf(!id.HasValue, "specified OrganizationUser.Id was null");
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<OrganizationUserColumns> where, Database database = null)
		{
			SetOneWhere(where, out OrganizationUser ignore, database);
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<OrganizationUserColumns> where, out OrganizationUser result, Database database = null)
		{
