...
namespace Bam.Net.CoreServices.ApplicationRegistration.Data.Dao
{
	...
	[Serializable]
	[Bam.Net.Data.Table("Nic", "ApplicationRegistration")]
	...
	public Machine MachineOfMachineId
	{
		...
		public static Nic GetById(uint? id, Database database = null)
		{
			...
			Args.ThrowIf(!id.HasValue, "specified Nic.Id was null");
		...
		public static Nic GetById(ulong? id, Database database = null)
		{
			Args.ThrowIfNull(id, "id");
			Args.ThrowIf(!id.HasValue, "specified Nic.Id was null");
			return GetById(id.Value, database);
		...
		[Bam.Net.Exclude]
		public static NicCollection Top(int count, QueryFilter where, string orderBy = null, SortOrder sortOrder = SortOrder.Ascending, Database database = null)
		{
			Database db = database ?? Db.For<Nic>();
			QuerySet query = GetQuerySet(db);
			query.Top<Nic>(count);
