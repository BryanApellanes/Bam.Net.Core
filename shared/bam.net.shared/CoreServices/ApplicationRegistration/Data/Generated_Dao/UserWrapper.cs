	...
	public class UserWrapper: Bam.Net.CoreServices.ApplicationRegistration.Data.User, IHasUpdatedXrefCollectionProperties
	{
		...
		public override Bam.Net.CoreServices.ApplicationRegistration.Data.Subscription[] Subscriptions
		{
			get
			{
				...
				{
					_subscriptions = DaoRepository.ForeignKeyCollectionLoader<Bam.Net.CoreServices.ApplicationRegistration.Data.User, Bam.Net.CoreServices.ApplicationRegistration.Data.Subscription>(this).ToArray();
				}
...
// Right Xref property: Left -> Organization ; Right -> User
		...
		public override List<Bam.Net.CoreServices.ApplicationRegistration.Data.Organization> Organizations
		{
			get
			{
				...
				{
					var xref = new XrefDaoCollection<Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.OrganizationUser, Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.Organization>(DaoRepository.GetDaoInstance(this), false);
