...
namespace Bam.Net.CoreServices.AssemblyManagement.Data.Dao
{
	...
	public ProcessRuntimeDescriptor ProcessRuntimeDescriptorOfProcessRuntimeDescriptorId
	{
		...
		public static AssemblyDescriptorProcessRuntimeDescriptor GetById(uint? id, Database database = null)
		{
			...
			Args.ThrowIf(!id.HasValue, "specified AssemblyDescriptorProcessRuntimeDescriptor.Id was null");
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<AssemblyDescriptorProcessRuntimeDescriptorColumns> where, Database database = null)
		{
			SetOneWhere(where, out AssemblyDescriptorProcessRuntimeDescriptor ignore, database);
		}
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static void SetOneWhere(WhereDelegate<AssemblyDescriptorProcessRuntimeDescriptorColumns> where, out AssemblyDescriptorProcessRuntimeDescriptor result, Database database = null)
		{
