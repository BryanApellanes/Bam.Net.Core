...
namespace Bam.Net.Schema.Org.Things
{
	...
	public class AnatomicalSystem: MedicalEntity
	{
		...
		///<summary>Specifying something physically contained by something else. Typically used here for the underlying anatomical structures, such as organs, that comprise the anatomical system.</summary>
		public OneOfThese<AnatomicalStructure,AnatomicalSystem> ComprisedOf {get; set;}
