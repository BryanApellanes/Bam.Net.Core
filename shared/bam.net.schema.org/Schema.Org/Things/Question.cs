...
namespace Bam.Net.Schema.Org.Things
{
	...
	{
		///<summary>The answer(s) that has been accepted as best, typically on a Question/Answer site. Sites vary in their selection mechanisms, e.g. drawing on community opinion and/or the view of the Question author.</summary>
		public OneOfThese<Answer,ItemList> AcceptedAnswer {get; set;}
		...
		public OneOfThese<Answer,ItemList> SuggestedAnswer {get; set;}
