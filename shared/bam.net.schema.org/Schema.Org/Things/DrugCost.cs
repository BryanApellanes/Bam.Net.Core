...
namespace Bam.Net.Schema.Org.Things
{
	...
	public class DrugCost: MedicalEnumeration
	{
		...
		///<summary>The currency (in 3-letter of the drug cost. See: http://en.wikipedia.org/wiki/ISO_4217</summary>
		...
		public OneOfThese<Number,QualitativeValue,Text> CostPerUnit {get; set;}
