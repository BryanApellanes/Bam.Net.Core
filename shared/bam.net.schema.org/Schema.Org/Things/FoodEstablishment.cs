...
namespace Bam.Net.Schema.Org.Things
{
	...
	public class FoodEstablishment: LocalBusiness
	{
		...
		///<summary>Either the actual menu as a structured representation, as text, or a URL of the menu. Supersedes menu.</summary>
		public OneOfThese<Menu,Text,Url> HasMenu {get; set;}
